      ...
      <div className="flex flex-col gap-1.5">
        ...
        {allRows.map(row => (
          <div key={row.id} className="flex items-center gap-1">
            {/* Row label */}
            <div className="w-24 shrink-0 flex items-center gap-1.5 min-w-0 pr-1">
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="pt-1">
        ...
        <h1 className="text-2xl font-black mt-0.5"><span className="text-ql">G</span><span style={{ color: 'var(--ql-accent)' }}>AI</span><span className="text-ql">N</span></h1>
      </div>
